...
urlpatterns = [
    ...
    path(
        "document/<int:pk>/tags/",
        views.document_update_tags,
        name="document_update_tags",
    ),
    # Protected media access (authentication required)
    path(
        "document/<int:pk>/download/", views.document_download, name="document_download"
    ),
    ...
    path(
        "document/s/<str:token>/download/",
        views.document_download_signed,
        name="document_download_signed",
    ),
    path(
        "document/s/<str:token>/view/",
        views.document_view_signed,
        name="document_view_signed",
    ),
    # Denial Decoder
    ...
    path(
        "decode/<int:pk>/status/",
        views.denial_decoder_status,
        name="denial_decoder_status",
    ),
    # Rating Analyzer
    path("rating-analyzer/", views.rating_analyzer_upload, name="rating_analyzer"),
    path(
        "rating-analyzer/<int:pk>/",
        views.rating_analyzer_result,
        name="rating_analyzer_result",
    ),
    path(
        "rating-analyzer/<int:pk>/status/",
        views.rating_analyzer_status,
